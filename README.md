...
-   `mechcommit.actionStrings.addedFiles`: This allows you to change the currenlty highlighted text in the example <mark style="background: rgba(1, 1, 0, 1)" >Added</mark>: test.json, test1.json;
